...
<head>
    ...
    <title>User Login - {{env('APP_NAME')}}</title>
...
<body class="theme-light" data-highlight="blue2">
        ...
        <div class="page-content">
            ...
            <div class="card card-style mt-5">
                ...
                <div class="content mt-2 mb-0">
                    <h2 class="mb-3 color-dark">Forgot Password</h2>
                    <form method="POST" action="{{ route('login') }}">
                        @csrf
                        <div class="input-style no-borders has-icon validate-field mb-4">
                            <i class="fa fa-user"></i>
                            <input type="number" class="form-control validate-name" id="form1a" name="phone"
                                placeholder="Phone" required
                                oninput="this.value = this.value.slice(0, 10); if (this.value.length > 10) this.value = this.value.slice(0, 10);">
                            <label for="form1a" class="color-blue-dark font-10 mt-1">{{ __('messages.phone') }}</label>
                        ...
                        <center>
                            <input type="submit"
                                class="btn btn-m mt-4 mb-4 btn-full bg-blue-dark rounded-sm text-uppercase font-900" style="background-color: #3b5998;"
                                value="Submit">
                        </center>
                    </form>
    ...
    <div class="position-fixed" style="    top: 11px;
    right: 3px;">
