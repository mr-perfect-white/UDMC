...
<div class="container mt5">
    ...
    <div class="stat-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-number color-pickup">{{ $totalAssigned }}</div>
            <div class="stat-divider"></div>
            <div class="stat-sub-row">
                <div>
                    <div class="stat-sub-number color-pending">{{ $pendingPickup }}</div>
                    <div class="stat-sub-label">Pending</div>
                </div>
                <div>
                    <div class="stat-sub-number color-completed">{{ $totalCompleted }}</div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-number color-dump">{{ $totalCompleted }}</div>
            <div class="stat-divider"></div>
            <div class="stat-sub-row">
                <div>
                    <div class="stat-sub-number color-pending">{{ $pendingDump }}</div>
                    <div class="stat-sub-label">Pending</div>
                </div>
                <div>
                    <div class="stat-sub-number color-completed">{{ $totalCompleted }}</div>
    ...
    <a href="{{ route('vehicle.tickets.available') }}" class="cta-card">
                ...
                <div class="col-6">
                    <div class="ticket-card">
                        ...
                        @php
                            ...
                            $isDump = in_array($ticket->status, ['ready_to_dump', 'dump_submitted']);
                        @endphp
