                    ...
                    <div class="card-body">
                        <div class="media static-widget">
                            <div class="media-body">
                                ...
                                <h3 class="mb-0 counter">{{ $count }} </h3>
                            </div>
            ...
            <div class="col-sm-4 col-xl-4 col-lg-4">
                <div class="card o-hidden">
                    <div class="card-body">
                        <div class="media static-widget">
                            <div class="media-body">
                                <h6 class="font-roboto">Approved</h6>
                                <h3 class="mb-0 counter">{{  $activecount }}</h3>
                            </div>
            ...
            <div class="col-sm-4 col-xl-4 col-lg-4">
                <div class="card o-hidden">
                    <div class="card-body">
                        <div class="media static-widget">
                            <div class="media-body">
                                <h6 class="font-roboto">Processing</h6>
                                <h3 class="mb-0 counter">{{   $pendingcount }}</h3>
                            </div>
